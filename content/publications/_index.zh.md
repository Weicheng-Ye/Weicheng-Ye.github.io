...
publications:
  - categories:
    ...
    description: "我们发展了一种用于构造 (3+1) 维拓扑量子场论的费米子框架，以实现给定的有限对称性反常。该框架证明了超上同调反常的可实现性，同时识别出超上同调之外的一种障碍。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    citation: "arXiv 预印本（2024）。"
    status: "已撤回"
    description: "本文提出将高阶中心荷作为共形边界条件的障碍，并研究其晶格实现。该稿件已撤回：证明不正确，相关猜想仍未解决。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    description: "我们计算了全部 230 个三维空间群的模 2 上同调环，并据此导出 Lieb-Schultz-Mattis 约束。这些结果为分析晶体量子多体系统提供了工具。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    description: "我们将 (2+1) 维费米子拓扑序的反常指标表述为 (3+1) 维拓扑量子场论的配分函数。该方案恢复了已知指标，并在非平凡例子中得到检验。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    description: "我们引入子系统方差，以连接电路复杂度与近似量子纠错。它给出复杂度下界，并确定了子系统方差的 O(k/n) 阈值（当 k 固定时为 O(1/n)）。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    citation: "arXiv 预印本（2025）。"
    description: "我们结合影子层析与时间序列机器学习，在无需局域序参量的条件下识别量子相。对 Ising 与 ANNNI 模型的测试复现了其已知相边界。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    citation: "arXiv 预印本（2024）。"
    description: "我们将拓扑全息的对称性 TQFT 描述推广至费米子系统，并恢复其对称性与拓扑数据。该构造还给出一种新的内禀无能隙费米子 SPT 相。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    description: "我们系统分类了具有晶格、内部、反幺正及任意子置换对称性的二维对称性富集拓扑量子自旋液体，其中包含通常的 parton 平均场方法难以刻画的例子。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    description: "我们给出了一个 (3+1) 维 TQFT 框架，用于计算 (2+1) 维对称性富集拓扑序的反常指标。它涵盖一般对称性，包括强制无能隙和量子化霍尔响应的情形。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    description: "我们表明，测量诱导纠缠可以诊断多体波函数的符号结构。该方法证明了无符号稳定子态和无符号双量子比特波函数的上界，并区分具有符号结构的临界体系与混合体系。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    description: "我们利用拓扑配分函数刻画 Lieb-Schultz-Mattis 约束，并将该框架应用于对称性富集量子临界性。它识别出对奇异临界态和对称性破缺的约束。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    citation: "Physical Review Letters 128, 106402 (2022). [编辑推荐]"
    description: "我们表明，虚 Cooper 对会在边缘费米液体中产生高圈阶的紫外—红外混合。这会增强低能相互作用，并缩小弱耦合不动点的吸引域。"
    arxiv:
      label: "arXiv"
  ...
  - categories:
    ...
    description: "我们计算了大 D 极限下 Gauss-Bonnet 黑洞的准正规模谱。该分析利用解析与数值方法揭示了新的大耦合行为。"
    arxiv:
      label: "arXiv"
